...
const AboutSection: React.FC = () => {
  return (
    <>
      <section
        id="about"
        className="relative sm:pt-[60px] tablet:pt-[108px] pt-[142px] pl-2 pr-4 lg:px-[30px] lg:pb-[15px] pb-[150px] overflow-visible"
      >
        <div className="flex justify-between lg:mb-0 mb-[58px]">
          <h2
          ...
          <div className="flex justify-between self-end gap-8 xl:gap-[unset]">
            <div className="lg:absolute sm:top-[60px] tablet:top-[108px] top-[142px] left-[85px] lg:left-[30px]">
              <Title title={"ПРО КЛУБ"} />
            </div>
            <div className="flex flex-col items-start tablet:max-w-[416px] max-w-[477px]">
              <p className="sm:mt-[60px] tablet:mt-[100px] md:text-18 max-w-[437px]">
                Наш клуб є частиною олімпійського руху. Ми орієнтовані на
                спортивні досягнення наших учнів та розвиток олімпійського
                тхеквондо в Україні.
              </p>
              <span className="lg:hidden border-b border-[#f16669] w-1/2 mt-7" />
            </div>
          </div>
        </div>
        <h2
          ...
          className="lg:mb-0 mb-[50px] lg:hidden mx-3 xl:text-[180px] text-[230px] font-extrabold tracking-[34.5px] leading-[207px]  transition duration-500 hover:bg-gradient-to-r from-[#09142e] via-[#58275f] to-[#f85253] bg-clip-text text-transparent bg-[2px] hover:bg-clip-text"
        >
          KWON
        </h2>
        <div className="flex lg:mb-0 mb-[50px]">
          <h2
            style={{
              WebkitTextStroke: "1px #b3adad",
              fontFamily: "MontserratBlack",
        ...
        <h2
          ...
          className="lg:mb-0 mb-[41px] lg:hidden mx-3 xl:text-[180px] text-[230px] font-extrabold tracking-[34.5px] leading-[207px] transition duration-500 hover:bg-gradient-to-r from-[#09142e] via-[#58275f] to-[#f85253] bg-clip-text text-transparent bg-[2px] hover:bg-clip-text"
        >
          KYIV
        </h2>
        <div className="flex flex-col items-start mt-[41px] ml-[67px] lg:ml-0 lg:mt-4 tablet:max-w-[416px] max-w-[477px]">
        ...
        <div className="lg:[&_p]:mb-[initial] [&_p]:mb-[18px] absolute sm-t-md:hidden right-[117px] bottom-[163px] lg:bottom-1/2 lg:translate-y-full lg:right-[30px] font-Montserrat font-normal leading-24 tracking-[0.12em] ml-[50px] bg-gradient-to-r from-[#09142e] via-[#58275f] to-[#f85253] bg-clip-text text-transparent uppercase">
