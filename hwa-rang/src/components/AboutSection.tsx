            ...
            <div className="flex justify-between">
                ...
                <div className="flex flex-col items-start max-w-[477px]">
                    <p className="mt-[60px] md:text-18">
                        Наш клуб є частиною олімпійського руху. Ми орієнтовані
                        на спортивні досягнення наших учнів та розвиток
                        олімпійського тхеквондо в Україні.
                    </p>
            ...
            <div className="flex">
                ...
                <div className="flex flex-col items-start pl-[50px] lg:p-0 max-w-[477px]">
                    <p className="ml-90px mt-[70px] lg:mt-4 md:text-18">
                        Ми працюємо з дітьми та дорослими будь- якого рівня
                        підготовки. В нас тренуються як досвідченні спортсмени
                        так і початківці.
                    </p>
                    <span className="lg:hidden  border-b border-[#f16669] w-1/2  mt-7"></span>
                </div>
